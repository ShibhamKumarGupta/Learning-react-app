...
function App() {
  ...
  const HeaderData = {
    ...
    desc: "This is My First Project on React Hope you all are fine."
  }
  const ContentData = {
    title: "Our Agency, our selves.",
    desc: "This is the content section of my First react project.",
    image: "https://dummyimage.com/600x400/000/fff",
    altImage: "Agency Image"
  }
  const ServicesData = [
    { title: "Photoshop", description: "Expert photo editing and designing services." },
    { title: "Javascript", description: "Building interactive and dynamic web applications." },
    { title: "Marketing", description: "Strategic marketing solutions to boost your brand." },
  ];
  const StatsData = [
  ...
  const GallaryImages = [
    "https://dummyimage.com/550x550/000/fff",
    "https://dummyimage.com/550x550/000/fff",
    "https://dummyimage.com/550x550/000/fff",
    "https://dummyimage.com/550x550/000/fff",
    "https://dummyimage.com/550x550/000/fff",
  ...
  const FooterData = {
    para: " 2025 Yeti Agency. All rights reserved."
  }
  ...
  return (
    ...
    <div className="container">
      ...
      <Stats statProps={StatsData}/>
      <hr />
      <div className="row column">
      <h3>Our Recent Work</h3>
    </div>
      <Gallary gallaryProps={GallaryImages}/>
      <MenuLink menuProps={MenuData}/>
      <hr/>
      <Footer footerProps={FooterData}/>
      </div>
    </>
  )
}
